...
namespace PuppetMaster
{
    public static class KB
    {
        ...
        {
            PClick = Left = Right = Up = Down = Activate = Action = Action2 = ActionHeld = Action2Held = Aim = Shift = Control = Alt = Modifier = MouseDown = Mouse2Down = Emote = Inventory = PClick = false;
            ...
            PClick          = Modifier && Input.GetMouseButtonUp(0);
            ...
            AnyKey = Up || Down || Left || Right || Activate || Action || Action2 || ActionHeld || Action2Held || Throw || Aim || Emote || MouseDown || Mouse2Down || Inventory || PClick;
        ...
        {
            Util.Notify("<color=red>Swapping Bindings to:</color> " + (useCustom ? "CUSTOM" : "DEFAULT"), Util.VerboseLevels.Full); 
